...
ActiveRecord::Schema.define(version: 20_190_709_160_217) do
  ...
  create_table 'friends', force: :cascade do |t|
    ...
    t.index %w[user_id friended_user_id], name: 'index_friends_on_user_id_and_friended_user_id', unique: true
