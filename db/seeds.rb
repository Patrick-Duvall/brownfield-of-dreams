...
User.create!(email: 'user@example.com', first_name: 'User', last_name: 'McUser', password: 'password', token: ENV['GITHUB_OAUTH_TOKEN'], active: true, github_name: 'test-freind')

User.create!( github_id: 35_322_570, github_name: 'Patrick-Duvall', first_name: 'Patrick', password: 'password', email: 'patrick@example.com')
